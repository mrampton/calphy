...
class Acceleration {
	  ...
	  Acceleration(double value_x, double value_y, String units) {
	  	...
	  	switch(unitlist[1]) {
	  		case "ns":
	  			this.value_x = value_x/(Math.pow(10,-9)*Math.pow(10,-9));
	  			this.value_y = value_y/(Math.pow(10,-9)*Math.pow(10,-9));
	  			break;
	  		case "ms":
	  			this.value_x = value_x/(Math.pow(10,-3)*Math.pow(10,-3));
	  			this.value_y = value_y/(Math.pow(10,-3)*Math.pow(10,-3));
	  			break;
	  		case "s":
	  			this.value_x = value_x;
	  			this.value_y = value_y;
